...
public struct PlaygroundPresenter {
    public static func presenter(for viewController: UIViewController) -> UIView {
        let presenter = UIViewController()
        presenter.view.frame = CGRect(x: 0, y: 0, width: 375, height: 667)
        presenter.embed(viewController)
